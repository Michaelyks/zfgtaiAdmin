...
<div class="pageindex2">
		...
		<a href="${pageUtil.pageUrl}&currentPage=1&pageSize=${pageUtil.pageSize}${anchor}" class="num-page active">1</a>
		<a href="${pageUtil.pageUrl}&currentPage=1&pageSize=${pageUtil.pageSize}${anchor}" class="num-page">2</a>
		<c:if test="${pageUtil.currentPage>1}">
