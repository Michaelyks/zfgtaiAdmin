...
<div align="center">
  <div class="main">
	...
	<form action="${pageContext.request.contextPath}/Product/Admin/releaseProduct!releaseProduct.action" id="frm" method="post" enctype="multipart/form-data" onsubmit="return isSubmit()" >
			<table border="1" style="width: 850px;">
				...
				<tr>
					...
					目前已发布 <font color="red">${productCount}</font> 个产品(含新手专享产品)
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="leftText">
					<label><input type="radio"  class="radioItem" name="product.isJiangLi"   checked="checked" value="0">否</label>
				...
				<tr>
					...
					<td class="leftText">
					<input id="jiangLiEarnings" readonly="readonly"  name="product.jiangLiEarnings" style="width: 50px">%
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
