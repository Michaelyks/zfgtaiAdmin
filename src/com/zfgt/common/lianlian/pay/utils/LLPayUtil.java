package com.zfgt.common.lianlian.pay.utils;
...
import com.zfgt.common.lianlian.pay.utils.enums.SignTypeEnum;
...
public class LLPayUtil{
	...
	public static boolean checkSignMD5(JSONObject reqObj, String md5_key)
    {
        ...
        try
        {
        	...
        	System.out.println("最终返回结果："+Md5Algorithm.getInstance().md5Digest(
